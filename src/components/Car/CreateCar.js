...
class CreateCar extends React.Component {
    ...
    handleSubmit(e) {
        ...
        if (
            ...
            this.state.carMake == null ||
            this.state.cost == null ||
            this.state.type == null ||
            this.state.costOnDay == null ||
            ...
            <div className={"content"}>
                <form className="content__create-form" onSubmit={this.handleSubmit.bind(this)}>
                    <Grid container spacing={2} justify={"center"}>
                        ...
                        <Grid item xs={12} md={6} lg={6}>
                            <TextField onChange={this.handleOnValueChange.bind(this)} id="costOnDay"
                                       value={this.state.costOnDay}
                                       type="text"
                                       variant="outlined" label="Цена за сутки"
                                       fullWidth
                                       InputLabelProps={{
                                           shrink: true,
                                       }}
